...
void vec3::rot_xz(float alpha) {vec2 susik = rot(vec2(x, z), alpha); x = susik.x; z = susik.y;}
void vec3::rot_yz(float alpha) {vec2 susik = rot(vec2(y, z), alpha); y = susik.x; z = susik.y;}
void vec3::rot_xy(float alpha) {vec2 susik = rot(vec2(x, y), alpha); x = susik.x; y = susik.y;}
